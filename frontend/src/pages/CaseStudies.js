...
import { ArrowRight, ArrowUpRight, Briefcase, TrendingUp, Users, Award } from 'lucide-react';
    ...
    <div data-testid="case-studies-page">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 md:p-12">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="text-xs font-mono tracking-[0.15em] uppercase text-white/50">
                        {study.industry}
                      </span>
                    </div>
                    ...
                    <div className="space-y-4 mb-8">
                      <div>
                        <p className="text-xs font-mono tracking-[0.15em] uppercase text-white/40 mb-1">Challenge</p>
                        <p className="text-white/70">{study.challenge}</p>
                      </div>
                      <div>
                        <p className="text-xs font-mono tracking-[0.15em] uppercase text-white/40 mb-1">Solution</p>
                        <p className="text-white/70">{study.solution}</p>
                      </div>
                      <div>
                        <p className="text-xs font-mono tracking-[0.15em] uppercase text-white/40 mb-1">Result</p>
      ...
      <section className="py-24 md:py-32 relative" data-testid="partners-section">
        <div className="section-container">
          ...
          >
            <div className="text-2xl font-bold tracking-tight" style={{ fontFamily: 'Syne, sans-serif' }}>Healthcare</div>
            <div className="text-2xl font-bold tracking-tight" style={{ fontFamily: 'Syne, sans-serif' }}>Technology</div>
            <div className="text-2xl font-bold tracking-tight" style={{ fontFamily: 'Syne, sans-serif' }}>Food & Beverage</div>
            <div className="text-2xl font-bold tracking-tight" style={{ fontFamily: 'Syne, sans-serif' }}>MedTech</div>
            <div className="text-2xl font-bold tracking-tight" style={{ fontFamily: 'Syne, sans-serif' }}>Finance</div>
          </motion.div>
        </div>
      </section>
